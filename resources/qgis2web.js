...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:25830',
            extent: [538482.995117, 4636680.797898, 690000.000000, 4800000.000000],
            units: 'm'})
    })
});
...
map.getView().fit([596662.834978, 4724737.235298, 597842.841122, 4725320.730983], map.getSize());
